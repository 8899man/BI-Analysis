 ...
 * @since   1.5
 */
public final class SysUUID 
implements java.io.Serializable, Comparable<SysUUID> {
     ...
     * @param  leastSigBits
     */
    public SysUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static SysUUID randomUUID() {
        ...
        return new SysUUID(randomBytes);
    }
    
    public static String getUUID(){
    	return SysUUID.randomUUID().toString();
    }
     ...
     */
    public static SysUUID nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
     ...
     */
    public static SysUUID fromString(String name) {
        ...
        return new SysUUID(mostSigBits, leastSigBits);
    }
	...
	if (!(obj instanceof SysUUID))
	    return false;
        if (((SysUUID)obj).variant() != this.variant())
            return false;
        SysUUID id = (SysUUID)obj;
     ...
     */
    public int compareTo(SysUUID val) {
