	...
	app.register.controller('ProjectHouseListCtrl', [
			...
			function($location, $modal, $filter, $scope, $rootScope, $state,
				...
				$scope.changeArea = function(){
			        ...
			        var areaCode = $scope.areaSelected.areaCode;
			        projectHouseListService.getCompany({"areaCode" : areaCode}, function(response, status){
			    ...
			    $scope.search = function(){
			    	...
			    	var info = {
							"areaName": $scope.areaSelected.areaName,
							"companyName": $scope.citySelected.companyName
					}
