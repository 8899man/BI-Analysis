	...
	Window.prototype = $.extend({}, new widget.Widget(), {
		renderUI: function(){
			...
			switch(this.cfg.winType){
				case "alert":
					footerContent = '<input type="button" value="' + this.cfg.text4AlertBtn + '" class="window_alertBtn btn btn-primary" />';
					break;
				case "confirm":
					footerContent = '<input type="button" value="' + this.cfg.text4ConfirmBtn + '" class="window_confirmBtn btn btn-primary" /><input type="button" value="' + this.cfg.text4CancelBtn + '" class="window_cancelBtn btn btn-default" />';
					break;
				default:
					break;
			}
