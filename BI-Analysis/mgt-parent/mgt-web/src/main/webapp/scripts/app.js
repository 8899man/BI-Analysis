...
define(
		[ 'angularAMD', 'config', 'util', 'window', 'directives', 'jquery',
				'ui-bootstrap', 'angular-sanitize', 'blockUI',
				'angular-ui-router', 'highcharts-ng', 'slider', 'toastr' ],
		function(angularAMD, config, util, w) {

			// console.log(util)
			var app = angular.module("app", [ 'blockUI', 'ngSanitize',
					'ui.bootstrap', 'ui.router', 'utilModule', 'highcharts-ng',
					'commonDirectives', 'ui.slider', 'toastr' ]);
			...
			app
					.config([
							...
							function($stateProvider, $urlRouterProvider) {
								...
								$stateProvider
										...
										.state(
												...
												angularAMD
														.route({
															...
															// +
															// config.templateVersion
															templateUrl : "views/direct/direct.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/show",
															templateUrl : "views/clientShow/clientShow.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/search",
															templateUrl : "views/clientSearch/clientSearch.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/details/:cstGUID",
															templateUrl : "views/clientDetails/clientDetails.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/show",
															templateUrl : "views/projectShow/projectShow.html?"
																	+ config.templateVersion,
										...
										.state(
												"app.project.list.houseList",
												angularAMD
														.route({
															url : "/houseList",
															templateUrl : "views/projectHouseList/projectHouseList.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/projectHouseList/projectHouseListCtrl'
														}))
										.state(
												"app.project.list.homeList",
												angularAMD
														.route({
															url : "/homeList",
															templateUrl : "views/projectHomeList/projectHomeList.html?"
																	+ config.templateVersion,
										...
										.state(
												"app.project.salesQuery",
												angularAMD
														.route({
															url : "/salesQuery/:projectId",
															templateUrl : "views/salesQuery/salesQuery.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/salesQuery/salesQueryCtrl'
														}))
										.state(
												"app.project.customerQuery",
												angularAMD
														.route({
															url : "/customerQuery/:projectId",
															templateUrl : "views/customerQuery/customerQuery.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/customerQuery/customerQueryCtrl'
														}))
										.state(
												"app.project.propertyQuery",
												angularAMD
														.route({
															url : "/propertyQuery/:projectId",
															templateUrl : "views/propertyQuery/propertyQuery.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/propertyQuery/propertyQueryCtrl'
														}))
										.state(
												"app.project.diskQuery",
												angularAMD
														.route({
															url : "/diskQuery/:projectId",
															templateUrl : "views/diskQuery/diskQuery.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/diskQuery/diskQueryCtrl'
														}))
										.state(
												"app.project.houseDetails",
												angularAMD
														.route({
															url : "/houseDetails/:houseId",
															templateUrl : "views/houseDetails/houseDetails.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/network",
															templateUrl : "views/labelNetwork/labelNetwork.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/local",
															templateUrl : "views/labelLocal/labelLocal.html?"
																	+ config.templateVersion,
										...
										.state(
												"app.marketing.customerClassify",
												angularAMD
														.route({
															url : "/customerClassify",
															templateUrl : "views/marketing/customerClassify/customerClassify.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/marketing/customerClassify/customerClassifyCtrl'
														}))
										.state(
												"app.marketing.investmentCustomer",
												angularAMD
														.route({
															url : "/investmentCustomer",
															templateUrl : "views/marketing/investmentCustomer/investmentCustomer.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/marketing/investmentCustomer/investmentCustomerCtrl'
														}))
										.state(
												"app.marketing.directed",
												angularAMD
														.route({
															url : "/directed",
															templateUrl : "views/marketing/directed/directed.html?"
																	+ config.templateVersion,
										...
										.state(
												"app.report.customer.ownerType",
												angularAMD
														.route({
															url : "/ownerType",
															templateUrl : "views/report/customer/ownerType/ownerType.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/report/customer/ownerType/ownerTypeCtrl'
														}))
										.state(
												"app.report.customer.turnoverCustomer",
												angularAMD
														.route({
															url : "/turnoverCustomer",
															templateUrl : "views/report/customer/turnoverCustomer/turnoverCustomer.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/report/customer/turnoverCustomer/turnoverCustomerCtrl'
														}))
										.state(
												"app.report.customer.repeatBuy",
												angularAMD
														.route({
															url : "/repeatBuy",
															templateUrl : "views/report/customer/repeatBuy/repeatBuy.html?"
																	+ config.templateVersion,
										...
										.state(
												"app.report.product.turnoverProduct",
												angularAMD
														.route({
															url : "/turnoverProduct",
															templateUrl : "views/report/product/turnoverProduct/turnoverProduct.html?"
																	+ config.templateVersion,
										...
										.state(
												"app.report.format.salesAnalysis",
												angularAMD
														.route({
															url : "/salesAnalysis",
															templateUrl : "views/report/format/salesAnalysis/salesAnalysis.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/sales",
															templateUrl : "views/dashboard/sales/dashboardSales.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/customer",
															templateUrl : "views/dashboard/customer/dashboardCustomer.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/dashboard/customer/dashboardCustomerCtrl'
														}))

										.state(
												"app.dashboard.purchas",
												angularAMD
														.route({
															url : "/purchas",
															templateUrl : "views/dashboard/purchas/dashboardPurchas.html?"
																	+ config.templateVersion,
										...
										.state(
												...
												angularAMD
														.route({
															url : "/borg",
															templateUrl : "views/system/bOrg/bOrgList.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/system/bOrg/bOrgListController'
														}))
										...
										.state(
												...
												angularAMD
														.route({
															url : "/function",
															templateUrl : "views/system/function/functionList.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/system/function/functionListController'
														}))
										...
										.state(
												...
												angularAMD
														.route({
															url : "/menu",
															templateUrl : "views/system/menu/menuList.html?"
																	+ config.templateVersion,
															controllerUrl : 'views/system/menu/menuListController'
														}))
										...
										.state(
												...
												angularAMD
														.route({
															url : '/sysUser',
															templateUrl : 'views/system/sysUser/sysUserList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/sysUser/sysUserListController'
														}))
										.state(
												'app.system.role',
												angularAMD
														.route({
															url : '/role',
															templateUrl : 'views/system/role/roleList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/role/roleListController'
														}))
										.state(
												'app.system.sysParam',
												angularAMD
														.route({
															url : '/sysParam',
															templateUrl : 'views/system/sysParam/sysParamList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/sysParam/sysParamListController'
														}))
										.state(
												'app.system.sysExport',
												angularAMD
														.route({
															url : '/sysExport',
															templateUrl : 'views/system/sysExport/sysExportList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/sysExport/sysExportListController'
														}))
										.state(
												'app.system.sysExportColumn',
												angularAMD
														.route({
															url : '/sysExportColumn/{id:[0-9]{1,4}}',
															templateUrl : 'views/system/sysExport/sysExportColumnList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/sysExport/sysExportColumnListController'
														}))
										.state(
												'app.system.adOrg',
												angularAMD
														.route({
															url : '/adOrg',
															templateUrl : 'views/system/adOrg/adOrgList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/adOrg/adOrgListController'
														}))
										.state(
												'app.system.adUser',
												angularAMD
														.route({
															url : '/adUser',
															templateUrl : 'views/system/adUser/adUserList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/adUser/adUserListController'
														}))
										.state(
												'app.system.industry',
												angularAMD
														.route({
															url : '/industry',
															templateUrl : 'views/system/industry/industryList.html?'
																	+ config.templateVersion,
															controllerUrl : 'views/system/industry/industryListController'
														}))
										// 外链嵌套路由跳转
										.state(
												"app.embed",
												angularAMD
														.route({
															url : "/embed/:menuId",
															templateUrl : "views/embed/embed.html?"
																	+ config.templateVersion,
								...
								// .when('/app/user/project',
								// '/app/user/projectlist/houseList')
								// .when('/app/user/project/list',
								// '/app/user/projectlist/houseList')
								/*
								 * .state("app.dashboard", angularAMD.route({
								 * url: "/dashboard", templateUrl:
								 * "views/Main/Welcome.html", controllerUrl:
								 * 'views/Main/WelcomeController' }));
								 */
			...
			var indexController = function($scope, $rootScope, $http,
				...
				$scope.initializeApplication = function(successFunction,
						errorFunction) {
					blockUI.start();
					$scope.AjaxGet("auth/initData", successFunction,
							errorFunction);
					blockUI.stop();
				};
