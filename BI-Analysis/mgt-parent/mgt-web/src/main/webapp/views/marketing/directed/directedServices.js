...
//            ajaxService.AjaxPost(salseQueryInfo, "api/marketing/directed/getCoverage.json", successFunction, errorFunction);
      ...
      //获取省份下的城市
        this.getProcitys = function (salseQueryInfo, successFunction, errorFunction) {
            ajaxService.AjaxFormPost(salseQueryInfo, "marketing/directed/getProCitys", successFunction, errorFunction);
        };
