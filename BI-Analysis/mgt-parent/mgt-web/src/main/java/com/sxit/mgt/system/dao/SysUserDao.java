...
public interface SysUserDao {
	 ...
	 * @param map
	 */
	public void addUserProject(Map map);
	
	
	public void addUserOrg(Map map);
	
	public void addUserIndustry(Map map);
	
	/**
	 * 删除用户角色
	 * @param map
	 */
	public void deleteUserProject(Map map);
	
	public void deleteUserOrg(Map map);
	
	
	public void deleteUserIndustry(Map map);
	...
	public List<String> getProjectIdListByMap(Map map);
	 ...
	 * @return
	 */
	public List<String> getOrgIdListByMap(Map map);
