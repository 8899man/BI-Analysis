...
//	}
	...
	public List<ProductProjectData> getPPDByUserId(String areaCode, String companyCode, String startDate, String endDate, int userId){
		Map<Object, Object> map = new HashMap<Object, Object>();
		map.put("areaCode", areaCode);
		map.put("companyCode", companyCode);
		map.put("startDate", startDate);
		...
		return bAreaCompanyDao.getPPDByUserId(map);
	}
	...
	public List<YeTaiZhuanShuDataDto> getYTZSDByCompetence(String startTime, String endTime, int userId){
		Map<Object, Object> map = new HashMap<Object, Object>();
		map.put("startTime", startTime);
		map.put("endTime", endTime);
		map.put("userId", userId);
		return bAreaCompanyDao.getYTZSDByCompetence(map);
	}
}
